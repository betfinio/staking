...
import { useProfit as useProfitC, useStaked as useStakedC } from '@/src/lib/query/conservative';
...
const InfoBlock: FC<{ type: StakingType }> = ({ type }) => {
	...
	return (
		<div className={'col-span-2 md:col-span-1 flex flex-col gap-2 lg:gap-4 justify-between'}>
			<SharedGameBlock
				games={[
					{
						amount: staked,
