import SingleInfo, { type SingleIngoProps } from '@/src/components/shared/SingleInfo.tsx';
...
const SharedGameBlock: FC<SharedGameBlockProps> = ({ games }) => {
	return (
		<>
			<div className={'w-full grid-cols-1 hidden md:grid md:grid-cols-3 gap-2 lg:gap-4 whitespace-nowrap '}>
				{games.map((game, i) => (
