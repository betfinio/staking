...
const NewStakes: FC<{ cycleStart: number }> = ({cycleStart}) => {
	...
	return (
		<Tooltip>
			<TooltipTrigger>
				<div
					className={'shrink-0 border border-[#FFC800] py-4 px-3 rounded-md bg-primary text-sm text-[#6A6F84]'}>
					<div className={'font-semibold text-center leading-[10px]'}>New stakes</div>
					<div className={'mt-5'}>
						<div className={'flex justify-center text-[#FFC800]'}>+<BetValue value={valueToNumber(newStaked[0])} withIcon={true}/>
						</div>
