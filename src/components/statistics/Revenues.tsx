import {PointSymbolProps, ResponsiveLine, SliceTooltipProps} from '@nivo/line'
...
const Revenues = () => {
	...
	return <div className={'border border-gray-800 rounded-lg p-2 w-full h-[400px] pb-[40px]'}>
...
const getLastFriday = () => {
	let lastFriday = DateTime.now().set({weekday: 5, hour: 12, minute: 0, second: 0, millisecond: 0});
